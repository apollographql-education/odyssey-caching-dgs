# (Odyssey Course) Caching in Subgraphs with Java & DGS

Welcome to the starter code for **Caching in Subgraphs with Java & DGS**. You can find the [course lessons and instructions](https://apollographql.com/tutorials/caching-subgraph-dgs) on Odyssey, [Apollo](https://apollographql.com)'s learning platform.
